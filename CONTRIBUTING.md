# Contributing to rsdot

This outlines how to propose a change to rsdot. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("PaulESantos/rsdot", fork = TRUE)`.
...
Please note that the rsdot project is released with a [Contributor Code
of Conduct](https://paulesantos.github.io/rsdot/CODE_OF_CONDUCT.md). By
